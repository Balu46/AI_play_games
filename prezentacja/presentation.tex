...
\begin{frame}{4. EDA w RL - Co analizujemy}
    W RL nie ma klas, a dane powstaja w trakcie interakcji. EDA oznacza analize trajektorii i rozkladów nagród w czasie:
    \begin{itemize}
        \item \textbf{Rozkład nagród wczasie (episodic return):} wykresach sumy nagród względem kroków symulacji.
        \item \textbf{Dlugosc epizodow:} rozkład długosci epizodów jako proxy stabilnosci.
...
\begin{frame}{LunarLander}
    \begin{figure}
        ...
        \begin{subfigure}{0.49\textwidth}
            \centering
            \ChartMedium{../cart_pole/debug_out_no_opt/comparison_rollout_ep_rew_mean.png}
...
\begin{frame}{LunarLander}
    \begin{figure}
        ...
        \begin{subfigure}{0.49\textwidth}
            \centering
            \ChartMedium{../lunar_lander/debug_out_no_opt/comparison_rollout_ep_rew_mean.png}
            \caption{Bez optymalizacji}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.49\textwidth}
...
\begin{frame}{CarRacing}
    \begin{figure}
        ...
        \begin{subfigure}{0.49\textwidth}
            \centering
            \ChartMedium{../car_racing/debug_out_no_opt/comparison_rollout_ep_rew_mean.png}
            \caption{Bez optymalizacji}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.49\textwidth}
