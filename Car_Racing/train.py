...
class Agent():
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions,
        ...
        self.path = '/home/jan/Informatyka/AI_games/lunar_lander/best_model.pth'
...
def traning():
    ...
    agent.save_best_model('/home/jan/Informatyka/AI_games/lunar_lander/best_model.pth')
    ...
    out_csv = "/home/jan/Informatyka/AI_games/lunar_lander/training_log.csv"
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("/home/jan/Informatyka/AI_games/lunar_lander/score_avg100.png", dpi=150)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("/home/jan/Informatyka/AI_games/lunar_lander/epsilon.png", dpi=150)
